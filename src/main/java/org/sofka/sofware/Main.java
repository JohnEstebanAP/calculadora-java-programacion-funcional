...
import static org.sofka.sofware.utilities.Menu.*;
import static org.sofka.sofware.utilities.MyPrintAbstract.log;
import static org.sofka.sofware.utilities.MyPrintAbstract.logMessage;
...
public class Main extends Menu {
    ...
    public static void main(String[] args) {
        ...
        puntos(new Multiplicar(list1, list2));
        puntos(new Dividir(list1, list2));
        puntos(new Mod(list1, list2));
        puntos(new Minimo(list1, list2));
        puntos(new Maximo(list1, list2));
        startMenu();
    }
    ...
    public static void startMenu() {
        ...
        elemenst.add("\n");
        elemenst.add("  1: Sumar");
        elemenst.add("  2: Restar");
        elemenst.add("  3: Multiplicar");
        elemenst.add("  4: Dividir");
        elemenst.add("  5: Resto (mod)");
        elemenst.add("  6: Número Mínimo");
        elemenst.add("  7: Número Máximo");
